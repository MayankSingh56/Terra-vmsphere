...
variable "template_name" { type = string description = "cloud-ready template name (Ubuntu cloud image etc.)" }

variable "vm_name" { type = string default = "simple-linux-vm" }
...
variable "ssh_public_key" { type = string default = "ssh-rsa AAAA... replace-with-your-key" }
